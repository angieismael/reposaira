...
class PersonaDAO(DBcon.DBcon):
    ...
    def insertarPersona(self, nombre, apaterno, amaterno, cedula, fnacimiento,sexo, direccion, celular, estado):
        ...
        """ % (nombre, apaterno, amaterno, cedula, fnacimiento,sexo, direccion, celular, estado)
      
    def eliminarPersona(self, nombre, apaterno, amaterno, cedula, fnacimiento,sexo, direccion, celular, estado):
        con=self.conexion().connect()
        sql="""delete from personas(nombre, apell_paterno, apell_materno, dni, fecha_nacimiento, sexo, direccion, celular, estado)
        values ('%s','%s','%s','%s','%s','%s','%s','%s', %i)
        """ % (nombre, apaterno, amaterno, cedula, fnacimiento,sexo, direccion, celular, estado)    
